...
public class ClientDevice {
	...
	// / CGRP : Create GRouP
	/*
	 * NB: *ip_addr* et *port* correspondent respectivement à l'adresse IP et au
	 * n° de port de l'appareil.
	 */
	...
	// / JGRP : Join GRouP
	/*
	 * NB: *ip* et *port* correspondent respectivement à l'adresse IP et au n°
	 * de port de l'appareil.
	 */
